...
## Main takeaways
*Obs: the cutoff date for the preliminary result was April 19*.

- Consumer confidence slightly down in April, with diverging components: present situation slightly down and expectations slightly up.
- "Vacation intentions cooled but intentions to buy big-ticket items like automobiles and many appliances rose somewhat".
- "Concerns about inflation retreated from an all-time high in March but remained elevated".
